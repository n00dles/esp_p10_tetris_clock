...
// x shift for up to 8 characters
int xShiftClock[9] = {0, 7, 14, 21, 28 , 35, 42, 49, 56};
...
int blocksPerNumber[64] = {5,4,9,8,7,8,2,4,4,6,5,2,3,1,5,10,8,9,9,8,10,10,6,8,7,2,3,5,4,5,6,8,9,9,8,9,9,7,8,9,8,7,9,6,9,9,9,9,9,9,9,6,9,10,8,7,7,9};
